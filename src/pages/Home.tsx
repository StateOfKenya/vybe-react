  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const [statsRes, testimonialsRes, eventsRes, newsRes] =
          await Promise.all([
            getMembershipStats(),
            getTestimonials(),
            getEvents(),
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-2xl mx-auto">
            ...
            change. Join the movement that's transforming communities across all
            47 counties.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link to="/checheza-mtaani">
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-red-500 text-red-600 hover:bg-red-50 px-8 py-3 text-lg"
              >
      ...
      <section className="bg-gradient-to-r from-red-600 via-green-600 to-yellow-600 text-white">
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join thousands of young Kenyans who are already creating positive
