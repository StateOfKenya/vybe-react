    ...
    setTimeout(() => {
      resolve({
        articles: [
          {
            _id: '1',
            title: 'Vybe Trybe Launches Biggest Youth Mobilization Campaign in Kenya',
            excerpt: 'Over 2,000 young Kenyans join the movement for positive change across all 47 counties.',
            content: `
              <p>In a historic moment for youth empowerment in Kenya, Vybe Trybe has officially launched what is being called the largest youth mobilization campaign in the country's recent history. The campaign, dubbed "One Vybe, One Trybe, One Kenya," has already attracted over 2,000 young participants from all 47 counties.</p>

              <p>The initiative focuses on three core pillars: environmental conservation, political engagement, and creative expression. Through a series of coordinated events, workshops, and community projects, Vybe Trybe aims to create a unified platform where young Kenyans can collaborate regardless of their tribal, political, or socioeconomic backgrounds.</p>
          ...
          {
            _id: '2',
            title: 'Checheza Mtaani: Bringing Competition to Every Street Corner',
            excerpt: 'The revolutionary tournament that transforms Nairobi constituencies into competitive arenas.',
            content: `
          ...
          {
            _id: '3',
            title: 'Environmental Heroes: Youth Leading Climate Action in Mombasa',
            excerpt: 'Young environmental activists in Mombasa organize massive beach cleanup and tree planting initiative.',
            content: `
              <p>The coastal city of Mombasa witnessed an unprecedented display of youth-led environmental activism last weekend as over 300 young people participated in a comprehensive beach cleanup and tree planting initiative organized by local Vybe Trybe members.</p>

              <p>The event, which took place along Diani Beach and extended to the nearby Shimba Hills, resulted in the collection of over 2 tons of plastic waste and the planting of 500 indigenous trees. The initiative was part of Vybe Trybe's nationwide environmental conservation program.</p>
